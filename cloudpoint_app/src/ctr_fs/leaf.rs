use crate::ctr_fs::{
    CtrArchive, CtrArchiveLeaf, CtrArchiveLeafContext, CtrFsPath, FS_ATTRIBUTE_DIRECTORY,
    FS_OPEN_READ, FS_OPEN_WRITE, FS_WRITE_FLUSH,
};
use anyhow::Result;
...
pub fn walk_tree(archive: Arc<CtrArchive>) -> Result<Tree<CtrArchiveLeaf>> {
